...
import { Button, TransitionablePortal, Icon, Image, Card } from 'semantic-ui-react';
  ...
  render() {
    return (
      <div>
        ...
        />
        <TransitionablePortal onClose={this.onPortalClose} open={this.state.open || this.state.viewCount == 0}>
          <Card style={{ position: 'fixed', right: '2rem', bottom: '2rem', width: '25vw', zIndex: 1000 }} color='grey'>
            ...
            <Card.Content>
              ...
              <Card.Description>
                ...
                <p>
                  Functionalities here are limited but carefully cherry-picked, so as to
                ...
                <p>
                  Pano doesn&apos;t steal information from you. Check the code if you
